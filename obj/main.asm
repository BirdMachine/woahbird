...
; This file was generated Sat Jun 24 21:14:21 2017
;--------------------------------------------------------
	.module main
	.optsdcc -mgbz80
...
;main.c:18: checkInput();				// Check for user input (and act on it)
	call	_checkInput
;main.c:19: updateSwitches();			// Make sure the SHOW_SPRITES and SHOW_BKG switches are on each loop
	call	_updateSwitches
;main.c:20: wait_vbl_done();			// Wait until VBLANK to avoid corrupting memory
	call	_wait_vbl_done
	jr	00102$
	ret
_main_end::
...
;main.c:31: VBK_REG = 0;
	ld	l, #0x4F
	ld	(hl),#0x00
;main.c:33: set_bkg_data(0,255,birdTitle_tile_data);
	...
	call	_set_bkg_data
	add	sp, #4
;main.c:34: set_bkg_tiles(0,0,20,18,birdTitle_map_data);
...
_menu_start::
_menu:
;main.c:47: set_bkg_data(0,255,birdWelcomeSM_tile_data);
	...
	call	_set_bkg_data
	add	sp, #4
;main.c:48: set_bkg_tiles(0,0,20,18,birdWelcomeSM_map_data);
	...
	ret
_menu_end::
;main.c:51: void checkInput() {
;	---------------------------------
; Function checkInput
; ---------------------------------
_checkInput_start::
_checkInput:
;main.c:53: if (joypad() & J_A) {
	call	_joypad
	ld	d,#0x00
	bit	4, e
	ret	Z
