...
; This file was generated Sun Jun 25 12:20:17 2017
;--------------------------------------------------------
	.module main
	.optsdcc -mgbz80
...
;main.c:17: while(1) {
00102$:
;main.c:19: checkInput();				// Check for user input (and act on it)
	call	_checkInput
;main.c:20: updateSwitches();			// Make sure the SHOW_SPRITES and SHOW_BKG switches are on each loop
...
_init_start::
_init:
;main.c:28: DISPLAY_ON;// Turn on the display
	ld	de,#0xFF40
	ld	a,(de)
	ld	e,a
	ld	d,#0x00
...
;main.c:32: VBK_REG = 0;
	ld	l, #0x4F
	ld	(hl),#0x00
;main.c:34: set_bkg_data(0,255,birdTitle_tile_data);
	...
	call	_set_bkg_data
	add	sp, #4
;main.c:35: set_bkg_tiles(0,0,20,18,birdTitle_map_data);
...
_menu_start::
_menu:
;main.c:48: set_bkg_data(0,255,birdWelcomeSM_tile_data);
	...
	call	_set_bkg_data
	add	sp, #4
;main.c:49: set_bkg_tiles(0,0,20,18,birdWelcomeSM_map_data);
	...
	ret
_menu_end::
;main.c:52: void weather() {
;	---------------------------------
; Function weather
; ---------------------------------
_weather_start::
_weather:
;main.c:53: set_bkg_data(0,255,sun2_tile_data);
	...
	call	_set_bkg_data
	add	sp, #4
;main.c:54: set_bkg_tiles(0,0,20,18,sun2_map_data);
...
;main.c:56: menu();
	jp	_menu
_weather_end::
;main.c:61: void checkInput() {
;	---------------------------------
; Function checkInput
; ---------------------------------
_checkInput_start::
_checkInput:
;main.c:63: if (joypad() & J_A) {
	call	_joypad
	ld	d,#0x00
	bit	4, e
	jr	Z,00102$
