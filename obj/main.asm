...
; This file was generated Sat Jun 24 19:32:01 2017
;--------------------------------------------------------
	.module main
	.optsdcc -mgbz80
...
;--------------------------------------------------------
	...
	.globl _helloWorld
	.globl _alpha
	.globl _bird_tile_data
	.globl _bird_map_data
	.globl _bird_tile_count
	.globl _bird_tile_data_size
	.globl _bird_tile_map_height
	.globl _bird_tile_map_width
	.globl _bird_tile_map_size
	.globl _init
...
_bird_tile_map_size:
	.dw #0x017A
_bird_tile_map_width:
	.dw #0x0015
_bird_tile_map_height:
	.dw #0x0012
_bird_tile_data_size:
	.dw #0x09B0
_bird_tile_count:
	.dw #0x017A
_bird_map_data:
...
;main.c:27: set_bkg_data(0, 47, alpha);		// Load 47 tiles into background memory
	...
	call	_set_bkg_data
	add	sp, #4
;main.c:31: set_bkg_tiles(0,6,10,2,helloWorld);		
	ld	de,#_helloWorld
	push	de
	ld	hl,#0x020A
	push	hl
...
;main.c:38: SHOW_BKG;
	...
	ret
_updateSwitches_end::
;main.c:41: void checkInput() {
;	---------------------------------
; Function checkInput
; ---------------------------------
_checkInput_start::
_checkInput:
;main.c:43: if (joypad() & J_B) {
	call	_joypad
	ld	d,#0x00
	bit	5, e
	ret	Z
...
;main.c:52: VBK_REG = 0;
	ld	l, #0x4F
	ld	(hl),#0x00
;main.c:54: set_bkg_data(0,255,bird_tile_data);
	ld	de,#_bird_tile_data
	push	de
	ld	l, #0x00
	push	hl
	call	_set_bkg_data
	add	sp, #4
;main.c:55: set_bkg_tiles(0,0,20,18,bird_map_data);
	ld	de,#_bird_map_data
	push	de
	ld	hl,#0x1214
	push	hl
	ld	hl,#0x0000
